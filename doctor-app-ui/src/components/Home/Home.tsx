...
import {Box,Flex, Button, Text,Card, CardBody,Input,Image,Stack,IconButton,useDisclosure,Drawer,DrawerOverlay,DrawerContent,DrawerCloseButton, DrawerHeader, DrawerBody, DrawerFooter, VStack} from "@chakra-ui/react";
        ...
        <DrawerContent>
          ...
          <DrawerBody>
            <VStack spacing={7} align="stretch">
              <Button color="black" variant="link" onClick={onClose}>
                Home
              </Button>
              <Button color="black" variant="link" onClick={onClose}>
                Doctors
